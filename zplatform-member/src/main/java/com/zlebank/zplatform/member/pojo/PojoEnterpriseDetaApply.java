...
public class PojoEnterpriseDetaApply implements java.io.Serializable {
	...
	public PojoEnterpriseDetaApply(long selfId, long enterpriseId,
			String memberId, String enterpriseName, Long coopInstiId,
			String mcc, String mccList, Long enterpriseInsti, Long province,
			Long city, Long street, String zoneCode, String postCode,
			String address, String cellPhoneNo, String email, String website,
			String cardType, String taxNo, String licenceNo, String orgCode,
			String corporation, String corpNo, String corpFile,
			String corpFileOpp, String taxFile, String licenceFile,
			String orgCodeFile, String contact, String contPhone,
			String contTitle, String contEmail, String contAddress,
			String contPost, String custFrom, String custMgr,
			String custMgrDept, Short isDelegation, String signatory,
			String signCertNo, String signCertFile, String signCertFileOpp,
			String status, Date firstTime, Long inUser, Date inTime,
			Long stexaUser, Date stexaTime, String stexaOpt, Long cvlexaUser,
			Date cvlexaTime, String cvlexaOpt, String notes, String remarks) {
		this.selfId = selfId;
		this.enterpriseId = enterpriseId;
