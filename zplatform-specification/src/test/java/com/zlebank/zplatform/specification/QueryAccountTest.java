...
public class QueryAccountTest  {
    ...
    @Test
    public void queryAccountByAcctCode() throws Exception, ClassNotFoundException, InstantiationException, IllegalAccessException{
        SpecificationParser parser = (SpecificationParser) springContext
                .getBean("specificationParser");
        SpecificationProcessor sign = (SpecificationProcessor) springContext.getBean("queryOneAccount");
...
//      System.out.println(res.getResCode()+res.getResDes());
    ...
    private JSONObject mockRequestJson() { 
        ...
        head.put(FILED_REQUEST_TYPE, RequestType.QUERY_ACCOUNT.getCode());
        ...
        content.put("acctCode", "622132110101100000000000368");
