...
public class MainSubject {
    ...
    static {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext(
                "classpath:AccountContextTest.xml");
        subjectservice = (SubjectService) context.getBean("subjectServiceImpl");
        busiAcctService = (BusiAcctService) context
                .getBean("busiAcctServiceImpl");
        subjectRuleService = (SubjectRuleService) context
                .getBean("subjectRuleServiceImpl");
        account = (AccountService) context.getBean("accountServiceImpl");
    }
    ...
    private List<String[]> readExcle(String y) throws BiffException, IOException{
      //创建一个list 用来存储读取的内容
        ...
        //创建输入流
        String proFilePath = System.getProperty("user.dir") + "\\demo\\新增科目和规则\\subjectVo.xls";
    ...
    private   void addExcel() throws BiffException, IOException{
